...
void writeAstroParams(struct FlagOptions *fo, struct AstroParams *p){
    ...
    if(fo->USE_MASS_DEPENDENT_ZETA) {
        // !!! SLTK: added SFR_MODEL
        LOG_INFO("AstroParams: [SFR_MODEL=%f, HII_EFF_FACTOR=%f, ALPHA_STAR=%f, ALPHA_STAR_MINI=%f, F_ESC10=%f (F_ESC7_MINI=%f), ALPHA_ESC=%f, M_TURN=%f, R_BUBBLE_MAX=%f, L_X=%e (L_X_MINI=%e), NU_X_THRESH=%f, X_RAY_SPEC_INDEX=%f, F_STAR10=%f (F_STAR7_MINI=%f), t_STAR=%f, N_RSD_STEPS=%f]",
             p->SFR_MODEL,
