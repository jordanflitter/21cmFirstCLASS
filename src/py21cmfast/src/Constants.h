...
// JordanFlitter: Interpolation table for Lya heating efficiencies
...
// JordanFlitter: I define the mass hygroden. This is the more precise quantity to use when calculating densities
#define _m_H_ (double) 1.6735575e-24 // hydrogen mass (g)
...
#define T21 (double) 0.0682 // temperature corresponding to the 21cm photon // JordanFlitter: Changed that to the correct value (it was 0.0628 in the past)
#define A10_HYPERFINE (double) 2.85e-15 // spontaneous emission coefficient in s^-1
// JordanFlitter: added effective number of relativistic neutrinos
#define N_EFF (double) 3.044

#define Lambda_21 (double) 21.106114054160 // JordanFlitter: Wavelength of 21cm Radiation in cm
#define A21_Lya (double) 6.24e8 // JordanFlitter: Spontaneous emission coefficient for Lyman-Alpha line in s^-1
// ----------------------------------------------------------------------------------------- //
...
//JordanFlitter: defined Z_ARRAY_NPTS and SDGF_K_NPTS
#define Z_ARRAY_NPTS (int) 70
#define SDGF_K_NPTS (int) 300
...
// JordanFlitter: variables related to the Lyman-Alpha heating file
...
// JordanFlitter: HyRec data prefix
#define HYREC_DATA_PREFIX (const char *) "Hyrec_data"
// JordanFlitter: S_alpha data (from Eq. A4 in arXiv: 2009.10746) filename
...
//JordanFlitter: I commented the following three lines. These parameters can now be found in global_params (this change was made in order to be able to
// vary these values for different cosmologies)
